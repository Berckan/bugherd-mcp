...
> BugHerd maintains an [official BugHerd MCP server](https://github.com/macropodhq/bugherd-mcp) that we recommend for improved performance and **user role-based access** — what each user can do via the MCP matches their role and permissions in BugHerd.
>
> [> Find out more here](https://github.com/macropodhq/bugherd-mcp)
>
